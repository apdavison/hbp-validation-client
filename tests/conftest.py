...
def myModelID(modelCatalog):
    model_catalog = modelCatalog
    model_name = "Model_{}_{}_py{}".format(
    ...
    model = model_catalog.register_model(
        ...
        instances=[
            ...
            {"source": "https://www.abcde.com", "version": "1.0a", "parameters": None},
            {
...
def myTestID(testLibrary):
    ...
    isinstance_id = testLibrary.add_test_instance(
        test_id=test["id"],
        version="2.0",
