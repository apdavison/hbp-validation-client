...
def generate_report(hbp_username="", result_list=[], remove_temp=False):
    """
    Create
    """
    ...
    for result_id in result_list:
        if result_id not in failed_uuids:
            pdf.cell(40)
